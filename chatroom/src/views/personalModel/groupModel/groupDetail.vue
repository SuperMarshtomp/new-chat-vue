<template>
    <div class="vchat-Detail">
        <v-apheader back="-1" style="background-color:transparent" class="vchat-Detail-header">
        ...
        <div class="vchat-Detail-container">
            <div class="group-users" v-if="applyFlag">
                ...
                <ul class="group-users-liitte-list">
                    <li v-for="(v, i) in groupUsers" :key="v.code" v-if="i < 9">
                        ...
                        <el-avatar :src="IMG_URL + v.userId.photo"></el-avatar>
            ...
            <div class="group-managers detail-item" v-if="!applyFlag">
                <div>
                    ...
                    <el-avatar :src="IMG_URL + v.userId.photo" v-for="(v, i) in managers" :key="v['_id']" v-if="i < 3"></el-avatar>
                </div>
                <p class="many">

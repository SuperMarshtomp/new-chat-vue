    ...
    export  default {
        ...
        data() {
            ...
            return {
                ...
                InmageUrl: process.env.VUE_APP_BACK_URL,
        ...
        methods: {
            setShowCrop() { // 打开裁剪框
                this.showCrop = true;
                this.cropUrl = process.env.VUE_APP_BACK_URL + this.groupImage;
            },

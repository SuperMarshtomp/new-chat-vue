<template>
    <div class="chat-theme-set">
        <ul class="theme-list">
            ...
            <li>
                <div class="theme-style2">
                    old
                </div>
                <el-button :type="projectTheme === 'old' ? 'success' : 'info'" :loading="setThemeIng === 'old'" @click="setTheme('old')">
                    <i class="el-icon-success el-icon--right" v-if="projectTheme === 'old'"></i>
                    {{getText('old')}}
                </el-button>
            </li>
        </ul>

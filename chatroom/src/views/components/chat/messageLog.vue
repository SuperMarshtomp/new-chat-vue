<template>
    ...
    >
        <div class="messageLog-container">
            <message-item type="other" @lookPhoto="lookPhoto" :v="v" v-for="(v, i) in messageLog" :key="i" class="other" v-if="v.type !== 'org' && v.type != 'game'"></message-item>
        </div>
